...
contract StakingPool {
    ...
    constructor() public {
        owner = msg.sender;
        end = block.timestamp + 7 days; // TODO: instead, make function to start period
    }
    ...
    function invest() external payable {
        ...
        uint256 amountInvested = msg.value - fee;
        owner.transfer(fee);
    ...
    function finalize() external {
        ...
        totalChange = address(this).balance % stake; // to be distributed to investors
    }
    ...
    function getChange() external {
        ...
        uint256 amount = totalChange * balances[msg.sender] / totalInvested; // amount of change to be distributed to investors
